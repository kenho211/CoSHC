...
# Edited by Ken Ho from the original code (https://github.com/microsoft/CodeBERT/blob/master/CodeBERT/codesearch/process_data.py) 
# to process the data for the CodeBERT model
